    ...
    <div className="flex">
        <section className="grid gap-8 p-8 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project) => (
              ...
              className=""
              >
              <Card className="bg-black border border-green-400/30 hover:border-green-500 shadow-md hover:shadow-green-500/20 transition duration-300">
                  ...
                  />
                  <h3 className="text-2xl font-semibold text-green-400 mb-2">{project.name}</h3>
